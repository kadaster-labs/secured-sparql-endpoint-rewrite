...
```bash
$ docker pull <azure-container-registry>/lock-unlock/rewrite:0.1.1
```
...
```bash
$ docker run -i --rm -p "3030:3030" --name LockUnlockFusekiServer -t lock-unlock/rewrite:0.1.1 --mem /ds
```
